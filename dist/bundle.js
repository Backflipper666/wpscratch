...
/******/ 	(() => {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "wpscratch:";
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkwpscratch"] = self["webpackChunkwpscratch"] || [];
...
if (window.matchMedia("screen and (min-width: 1200px)").matches) {
  __webpack_require__.e(/*! import() */ "src_styles_desktop_css").then(__webpack_require__.bind(__webpack_require__, /*! ./styles/desktop.css */ "./src/styles/desktop.css")).then(() => {
...
//1.5
{
  ...
  if (jquery__WEBPACK_IMPORTED_MODULE_0__(window).width() > 767 && jquery__WEBPACK_IMPORTED_MODULE_0__(window).width() <= 1199) {
  ...
  } else if (jquery__WEBPACK_IMPORTED_MODULE_0__(window).width() >= 1200) {
    button.addEventListener("click", () => {
      if (text.textContent == "Скрыть") {
        lenovo2.setAttribute("style", "visibility:hidden; display:none;");
        apple2.setAttribute("style", "visibility:hidden; display:none;");
